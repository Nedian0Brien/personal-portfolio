...
const RESEARCH_DETAIL_PATH = path.resolve(__dirname, "../web/research/biomedical-bert-adr.html");
...
function writeTextEdit(payload) {
  ...
  return { ok: true, file: path.relative(path.resolve(__dirname, ".."), htmlPath) };
}
