...
const buttonTemplate = String.raw`<button data-react-grab-ignore-events data-react-grab-portfolio-edit-text title="Edit text" aria-label="Edit text" class="contain-layout shrink-0 flex items-center justify-center cursor-pointer interactive-scale mx-[2px] size-[24px] rounded-sm border-none bg-transparent p-0 text-black/70 hover:bg-black/10 hover:text-black"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"></path><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"></path></svg>`;
...
function patchCompactRenderer(source, file) {
  ...
  next = next.replaceAll(
    ...
    "var t=Zt(),i=t.firstChild,l=i.firstChild,d=l.firstChild,f=d.firstChild,m=f.firstChild,g=f.nextSibling,_=g.firstChild,v=g.nextSibling,y=v.firstChild,b=v.nextSibling,k=b.firstChild,P=d.nextSibling;return A(t,`click`,e.onPanelClick,!0),A(t,`animationend`,e.onAnimationEnd),L(t2=>e.onExpandableButtonsRef?.(t2),d),A(m,()=>e.selectButton),A(_,()=>e.editTextButton===!1?null:e.editTextButton??portfolioEditTextButton()),A(y,()=>e.commentsButton),A(k,()=>e.copyAllButton),A(P,()=>e.toggleButton),A(t,()=>e.collapseButton??u2(),null),M((u3)=>{var h=",
  );
  next = next
    .replaceAll(
...
function patchFormattedRenderer(source, file) {
  ...
  next = next.replaceAll(
    ...
    "var t3 = Zt(), i = t3.firstChild, l3 = i.firstChild, d = l3.firstChild, f = d.firstChild, m2 = f.firstChild, g = f.nextSibling, _ = g.firstChild, v = g.nextSibling, y = v.firstChild, b = v.nextSibling, k2 = b.firstChild, P2 = d.nextSibling;\n    return ze(t3, `click`, e.onPanelClick, true), ze(t3, `animationend`, e.onAnimationEnd), We((t4) => e.onExpandableButtonsRef?.(t4), d), Ge(m2, () => e.selectButton), Ge(_, () => e.editTextButton === false ? null : e.editTextButton ?? portfolioEditTextButton()), Ge(y, () => e.commentsButton), Ge(k2, () => e.copyAllButton), Ge(P2, () => e.toggleButton), Ge(t3, () => e.collapseButton ?? u2(), null), S((u3) => {",
  );
  next = next
    .replaceAll(
      "v = g.nextSibling, y = v.firstChild, b = d.nextSibling;",
